SYSTEM_PROMPT = (
    ...
    "and image-to-video generation. Preserve the product constraints exactly. The\n"
    "web search tool is available for current public context when it improves scene\n"
    "specificity, but product-analysis constraints and visible image facts remain\n"
    "authoritative. The\n"
    "storyboard must be practical for a 9:16 social ad: short scenes, clear product\n"
    "visibility, smooth camera motion, and no unsupported product claims. The scene\n"
