SYSTEM_PROMPT = (
    ...
    "Use the web search tool to find current public context and research more or clarify current public context for the visible subjects. Use the web fetch tool to read known URLs returned by search.\n"
