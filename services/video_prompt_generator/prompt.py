SYSTEM_PROMPT = (
    ...
    "using the exact scene_id, duration, and generate_audio values from the "
    "brief. Include the supplied start_image_url placeholder; the service will "
    "replace it with the final URL or data URI. Write prompts that describe "
    "camera motion, subject motion, environment motion, continuity, pacing, "
