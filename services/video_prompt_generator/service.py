...
class VideoPromptGeneratorService(BasePromptService):
    ...
    def run(
        ...
        *,
        ...
        scene_briefs, video_settings_by_scene_id = self._scene_briefs(
            ...
            start_image_paths_by_scene_id=start_image_paths_by_scene_id or {},
        )
        ...
        payload = {
            ...
            "output_requirements": {
                ...
                "cfg_scale": 0.5,
                "use_local_start_image_path": True,
        ...
        for item in output.video_prompts:
            ...
            item.start_image_path = settings["start_image_path"]
    ...
    def _scene_briefs(
        *,
        storyboard: dict[str, Any],
        start_image_paths_by_scene_id: dict[str, str],
        ...
        for scene in storyboard_scenes(storyboard):
            ...
            start_image_path = (
                start_image_paths_by_scene_id.get(scene_id)
                or require_starting_image_path(scene)
            )
            duration = VideoPromptGeneratorService._format_duration(scene.get("duration_sec"))
    ...
    def _format_duration(duration_sec: Any) -> str:
        ...
        if isinstance(duration_sec, float) and duration_sec.is_integer():
