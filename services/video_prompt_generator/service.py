...
class VideoPromptGeneratorService:
    ...
    def run(
        ...
        return {'aspect_ratio': '9:16', 'element_bindings': [{'storyboard_ref': '@subject_id_0', 'kling_ref': '@Element0', 'description': 'PRIME Hydration Lemonade bottle: bright yellow 500 mL single-serve plastic bottle with yellow cap, minimal white label, large vertical black PRIME lettering with white outline, Lemonade flavor, HYDRATION near the bottom, sun-bright summer icon.'}, {'storyboard_ref': '@subject_id_1', 'kling_ref': '@Element1', 'description': 'Young adult summer crew: diverse stylish friends in festival-ready beachwear, sweaty, playful, cool, socially magnetic, moving from beach to festival to club.'}], 'scene_prompts': [{'scene_id': 'scene_1', 'duration_sec': 5.0, 'prompt_mode': 'multi', 'start_image_strategy': 'Use the generated campaign starting frame based on storyboard.starting_frame_description.', 'element_refs': ['@Element0', '@Element1'], 'text_overlay': {'required': True, 'copy_text': 'Bright by day.', 'safe_area': 'Center-lower safe area, leaving bottle label unobstructed', 'render_in_video_model': False}, 'payload': {'prompt': None, 'multi_prompt': [{'prompt': 'Extreme close-up, low angle on hot sand: @Element0, a bright yellow 500 mL PRIME Hydration Lemonade bottle with yellow cap and minimal white label, drops in slow motion and lands upright at center frame, label rotating into perfect view while the camera makes a slow push-in with slight handheld tremble. Sand grains burst outward in a glowing halo and heat shimmer ripples across the frame; lock the first frame, then let the impact flash drive a smash cut into the next beat.', 'duration': 2}, {'prompt': 'Wide vertical beach tableau: @Element0 remains the bright yellow hero centerpiece on pale sand, label facing camera and staying legible, while @Element1, a diverse crew of stylish summer friends in festival-ready beachwear, gathers around it. The camera makes a slow orbit around the group and bottle as one person twists the cap, another takes the first sip and exhales with relief; a beach umbrella pops open, a towel flutters, seagulls streak by, and sunlight intensifies. Keep the bottle identity fixed and hand off on a match cut to the yellow label.', 'duration': 3}], 'duration': 5, 'shot_type': 'customize', 'negative_prompt': 'blur, distort, low quality, warped product packaging, unreadable or misspelled label text, incorrect logo, extra brands, deformed hands, deformed faces, jitter, flicker, abrupt random cuts, random text overlays, subtitles, watermarks'}}, {'scene_id': 'scene_2', 'duration_sec': 5.0, 'prompt_mode': 'multi', 'start_image_strategy': "Use the previous generated scene's final frame as this scene's start frame.", 'element_refs': ['@Element0', '@Element1'], 'text_overlay': {'required': True, 'copy_text': 'Ready by night.', 'safe_area': 'Upper-middle safe area, avoiding faces and bottle label', 'render_in_video_model': False}, 'payload': {'prompt': None, 'multi_prompt': [{'prompt': 'Medium tracking shot through a crowded festival lane: @Element1, the diverse stylish summer crew, moves in sync through the crowd while one hand always holds @Element0, the bright yellow PRIME Hydration Lemonade bottle, at chest height with the label kept readable. The camera uses a fast lateral dolly with whip-pan accents as flags, LED screens, confetti, and pulsing bodies streak past in saturated color; maintain the bottle as the bright totem and transition with a whip-pan into the close-up.', 'duration': 2}, {'prompt': 'Close-up hero shot against neon festival lights: @Element0 rotates slowly with condensation sparkling, its yellow cap, white label, vertical black PRIME lettering, Lemonade flavor, and HYDRATION mark all preserved and legible. The camera makes a micro push-in with a subtle tilt-up while a friend from @Element1 takes a quick sip and passes the bottle on; laser beams and crowd silhouettes form a graphic halo, and the motion stays clean and refreshing. End on a neon flare dissolve.', 'duration': 3}], 'duration': 5, 'shot_type': 'customize', 'negative_prompt': 'blur, distort, low quality, warped product packaging, unreadable or misspelled label text, incorrect logo, extra brands, deformed hands, deformed faces, jitter, flicker, abrupt random cuts, random text overlays, subtitles, watermarks'}}, {'scene_id': 'scene_3', 'duration_sec': 5.0, 'prompt_mode': 'multi', 'start_image_strategy': "Use the previous generated scene's final frame as this scene's start frame.", 'element_refs': ['@Element0', '@Element1'], 'text_overlay': {'required': True, 'copy_text': 'Grab a PRIME Lemonade and keep your summer on.', 'safe_area': 'Lower-third safe area, centered, with bottle visible above text', 'render_in_video_model': False}, 'payload': {'prompt': None, 'multi_prompt': [{'prompt': 'Stylized club close-up on the bar: @Element0, the bright yellow PRIME Hydration Lemonade bottle with yellow cap and minimal white label, sits upright under neon and blacklight, condensation shining like chrome while the label remains clear. The camera performs a slow deliberate push-in with a slight dutch angle as laser grids sweep across mirrored surfaces and club smoke drifts in ribbons; hold the bottle as the calm center and cut on the bass hit.', 'duration': 2}, {'prompt': 'Vertical medium-wide dance shot in the neon club: @Element1, the diverse stylish summer crew, dances through the afterparty around @Element0, then one friend takes a final sip and re-enters the crowd with effortless composure. The camera circles handheld around the group while strobe flashes, silhouettes, and floating confetti create a surreal day-to-night continuity; keep the bottle identity fixed and finish on a final freeze with @Element0 in a hero pose.', 'duration': 3}], 'duration': 5, 'shot_type': 'customize', 'negative_prompt': 'blur, distort, low quality, warped product packaging, unreadable or misspelled label text, incorrect logo, extra brands, deformed hands, deformed faces, jitter, flicker, abrupt random cuts, random text overlays, subtitles, watermarks'}}]}
